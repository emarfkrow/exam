...
let TSosenGridColumns = [
    ...
    Column.cell('INSERT_DT', Messages['TSosenGrid.insertDt'], 300, 'metaInfo', Slick.Formatters.Extends.DateTime),
    Column.cell('INSERT_BY', Messages['TSosenGrid.insertBy'], 150, 'metaInfo', null),
    Column.cell('UPDATE_DT', Messages['TSosenGrid.updateDt'], 300, 'metaInfo', Slick.Formatters.Extends.DateTime),
