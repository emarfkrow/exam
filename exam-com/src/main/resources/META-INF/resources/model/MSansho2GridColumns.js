...
let MSansho2GridColumns = [
    ...
    Column.cell('INSERT_DT', Messages['MSansho2Grid.insertDt'], 285, 'metaInfo', Slick.Formatters.Extends.DateTime),
    Column.cell('INSERT_BY', Messages['MSansho2Grid.insertBy'], 150, 'metaInfo', null),
    Column.cell('UPDATE_DT', Messages['MSansho2Grid.updateDt'], 285, 'metaInfo', Slick.Formatters.Extends.DateTime),
