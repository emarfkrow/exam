...
let TEntity1HisGridColumns = [
    ...
    Column.comma('OYA_BN', Messages['TEntity1HisGrid.oyaBn'], 150, 'primaryKey numbering', null),
    Column.comma('ENTITY_BN', Messages['TEntity1HisGrid.entityBn'], 150, 'primaryKey numbering', null),
    Column.comma('HISTORY_BN', Messages['TEntity1HisGrid.historyBn'], 150, 'primaryKey numbering', null),
    Column.text('ENTITY1_MEI', Messages['TEntity1HisGrid.entity1Mei'], 300, '', null),
    Column.refer('SANSHO1_ID', Messages['TEntity1HisGrid.sansho1Id'], 150, '', 'null'),
    Column.text('SANSHO1_MEI', Messages['TEntity1HisGrid.sansho1Mei'], 300, '', null),
    Column.refer('SANSHO2_CD', Messages['TEntity1HisGrid.sansho2Cd'], 90, '', 'null'),
    Column.text('SANSHO2_MEI', Messages['TEntity1HisGrid.sansho2Mei'], 300, '', null),
    Column.refer('SANSHO3_NO', Messages['TEntity1HisGrid.sansho3No'], 150, '', 'null'),
    Column.text('SANSHO3_MEI', Messages['TEntity1HisGrid.sansho3Mei'], 300, '', null),
    Column.refer('BETSU_SANSHO1_ID', Messages['TEntity1HisGrid.betsuSansho1Id'], 150, '', 'null'),
    Column.text('BETSU_SANSHO1_MEI', Messages['TEntity1HisGrid.betsuSansho1Mei'], 300, '', null),
    ...
    Column.check('DELETE_F', Messages['TEntity1HisGrid.deleteF'], 30, ''),
];
