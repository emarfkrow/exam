...
let MSansho1GridColumns = [
    ...
    Column.cell('INSERT_DT', Messages['MSansho1Grid.insertDt'], 300, 'metaInfo', Slick.Formatters.Extends.DateTime),
    Column.cell('INSERT_BY', Messages['MSansho1Grid.insertBy'], 150, 'metaInfo', null),
    Column.cell('UPDATE_DT', Messages['MSansho1Grid.updateDt'], 300, 'metaInfo', Slick.Formatters.Extends.DateTime),
