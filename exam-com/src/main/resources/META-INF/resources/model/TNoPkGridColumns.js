...
let TNoPkGridColumns = [
    ...
    Column.cell('INSERT_DT', Messages['TNoPkGrid.insertDt'], 300, 'metaInfo', Slick.Formatters.Extends.DateTime),
    Column.cell('INSERT_BY', Messages['TNoPkGrid.insertBy'], 150, 'metaInfo', null),
    Column.cell('UPDATE_DT', Messages['TNoPkGrid.updateDt'], 300, 'metaInfo', Slick.Formatters.Extends.DateTime),
