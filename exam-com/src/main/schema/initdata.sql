...
INSERT INTO m_code_value(code_nm, code_value, code_value_mei, hyoji_jun, criteria, insert_dt, insert_by, update_dt, update_by) VALUES ('kengen_kb', '4', '追加', 5, '', SYSDATE(), 'initdata', SYSDATE(), 'initdata');
