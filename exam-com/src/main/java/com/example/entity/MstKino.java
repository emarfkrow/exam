 ...
 * @author emarfkrow
 */
public class MstKino implements IEntity {
     ...
     * @return 機能マスタ
     */
    public static MstKino get(final Object param1) {
        ...
        return Queries.get(sql, map, MstKino.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 機能マスタの登録
        String sql = "INSERT INTO mst_kino(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // 機能マスタの削除
        String sql = "DELETE FROM mst_kino WHERE " + getWhere();
