 ...
 * @author emarfkrow
 */
public class TEntity3 implements IEntity {
     ...
     * @return エンティティ３
     */
    public static TEntity3 get(final Object param1, final Object param2, final Object param3) {
        ...
        return Queries.get(sql, map, TEntity3.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // エンティティ３の登録
        String sql = "INSERT INTO t_entity3(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`ENTITY_BN`) IS NULL THEN 0 ELSE MAX(e.`ENTITY_BN`) * 1 END + 1 AS `ENTITY_BN` FROM t_entity3 e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int delete() {
        ...
        // エンティティ３の削除
        String sql = "DELETE FROM t_entity3 WHERE " + getWhere();
    ...
    public List<TKo> referTKos() {
        if (this.tKos == null) {
            this.tKos = TEntity3.referTKos(this.sosenId, this.oyaBn, this.entityBn);
        }
        return this.tKos;
    }
    ...
    public List<TTenpuFile> referTTenpuFiles() {
        if (this.tTenpuFiles == null) {
            this.tTenpuFiles = TEntity3.referTTenpuFiles(this.sosenId, this.oyaBn, this.entityBn);
        }
        return this.tTenpuFiles;
    }
