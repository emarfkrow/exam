 ...
 * @author emarfkrow
 */
public class MstKbnVal implements IEntity {
     ...
     * @return 区分値マスタ
     */
    public static MstKbnVal get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, MstKbnVal.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 区分値マスタの登録
        String sql = "INSERT INTO mst_kbn_val(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // 区分値マスタの削除
        String sql = "DELETE FROM mst_kbn_val WHERE " + getWhere();
