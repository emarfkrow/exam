...
public class Tb1Entity1 implements IEntity {
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        tb1Entity1His.setInsertDt(this.insertDt);
        tb1Entity1His.setInsertBy(this.insertBy);
        tb1Entity1His.setUpdateDt(this.updateDt);
        tb1Entity1His.setUpdateBy(this.updateBy);
