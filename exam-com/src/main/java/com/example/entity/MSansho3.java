 ...
 * @author emarfkrow
 */
public class MSansho3 implements IEntity {
     ...
     * @return 参照３マスタ
     */
    public static MSansho3 get(final Object param1) {
        ...
        return Queries.get(sql, map, MSansho3.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照３マスタの登録
        String sql = "INSERT INTO m_sansho3(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // 参照３マスタの削除
        String sql = "DELETE FROM m_sansho3 WHERE " + getWhere();
