 ...
 * @author emarfkrow
 */
public class MKino implements IEntity {
     ...
     * @return 機能マスタ
     */
    public static MKino get(final Object param1) {
        ...
        return Queries.get(sql, map, MKino.class);
    }
    ...
    public int delete() {
        ...
        // 機能マスタの削除
        String sql = "DELETE FROM m_kino WHERE " + getWhere();
