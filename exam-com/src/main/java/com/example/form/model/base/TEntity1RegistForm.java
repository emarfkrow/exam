 ...
 * @author emarfkrow
 */
public class TEntity1RegistForm implements IForm {
    ...
    /** エンティティ４ */
    @jakarta.validation.Valid
    private TEntity4RegistForm tEntity4RegistForm;

    /**
     * @return TEntity4RegistForm
     */
    public TEntity4RegistForm getTEntity4RegistForm() {
        return tEntity4RegistForm;
    }
     ...
     * @param p
     */
    public void setTEntity4RegistForm(final TEntity4RegistForm p) {
        this.tEntity4RegistForm = p;
    }
