 ...
 * @author emarfkrow
 */
public class TEntity1HisSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("TEntity1HisGrid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            TEntity1His e = FormValidator.toBean(TEntity1His.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
        }
