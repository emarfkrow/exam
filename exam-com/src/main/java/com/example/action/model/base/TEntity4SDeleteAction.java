 ...
 * @author emarfkrow
 */
public class TEntity4SDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("TEntity4Grid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            TEntity4 e = FormValidator.toBean(TEntity4.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
        }
