 ...
 * @author emarfkrow
 */
public class TEntity3SRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("TEntity3Grid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            TEntity3 e = FormValidator.toBean(TEntity3.class.getName(), gridRow);
