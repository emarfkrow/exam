 ...
 * @author emarfkrow
 */
public class TEntity1SRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("TEntity1Grid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            TEntity1 e = FormValidator.toBean(TEntity1.class.getName(), gridRow);
