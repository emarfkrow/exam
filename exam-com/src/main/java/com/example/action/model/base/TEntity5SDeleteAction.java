 ...
 * @author emarfkrow
 */
public class TEntity5SDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("TEntity5Grid");
        ...
        for (Map<String, Object> gridRow : gridData) {
            ...
            TEntity5 e = FormValidator.toBean(TEntity5.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
        }
