...
$(function() {
    Tb5TenseiYokushiSaki2GridColumns = [
        Column.comma('TENSEI_YOKUSHI_SAKI2_ID', Messages['Tb5TenseiYokushiSaki2Grid.tenseiYokushiSaki2Id'], 80, 'primaryKey numbering', null),
        Column.comma('TENSEI_YOKUSHI_ID', Messages['Tb5TenseiYokushiSaki2Grid.tenseiYokushiId'], 80, 'notblank', null),
