...
$(function() {
    Tb0NokeyGridColumns = [
        ...
        Column.text('COL_C', Messages['Tb0NokeyGrid.colC'], 300, 'primaryKey', null),
        Column.text('COL_D', Messages['Tb0NokeyGrid.colD'], 300, 'uniqueKey', null),
        Column.text('COL_E', Messages['Tb0NokeyGrid.colE'], 300, 'uniqueKey', null),
