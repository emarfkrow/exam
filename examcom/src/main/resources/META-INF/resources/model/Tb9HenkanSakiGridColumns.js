...
$(function() {
    Tb9HenkanSakiGridColumns = [
        Column.text('HENKAN_SAKI_ID', Messages['Tb9HenkanSakiGrid.henkanSakiId'], 90, 'primaryKey numbering', null),
        ...
        Column.cell('UPDATE_TS', Messages['Tb9HenkanSakiGrid.updateTs'], 207, 'metaInfo', Slick.Formatters.Extends.Timestamp),
    ];
});
