...
$(function() {
    Tb5TenseiSakiDetGridColumns = [
        Column.comma('TENSEI_SAKI_ID', Messages['Tb5TenseiSakiDetGrid.tenseiSakiId'], 80, 'primaryKey numbering', null),
        Column.comma('TENSEI_SAKI_BN', Messages['Tb5TenseiSakiDetGrid.tenseiSakiBn'], 80, 'primaryKey numbering', null),
