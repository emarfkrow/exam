...
$(function() {
    Tb8ChoiceGridColumns = [
        ...
        Column.refer('SUM_ID', Messages['Tb8ChoiceGrid.sumId'], 90, '', 'SUM_ID'),
        Column.text('SUM_INFO', Messages['Tb8ChoiceGrid.sumInfo'], 300, '', null),
        Column.refer('SUM2_ID', Messages['Tb8ChoiceGrid.sum2Id'], 90, '', 'SUM2_ID'),
        Column.text('SUM2_INFO', Messages['Tb8ChoiceGrid.sum2Info'], 300, '', null),
        Column.refer('SUM3_ID', Messages['Tb8ChoiceGrid.sum3Id'], 90, '', 'SUM3_ID'),
