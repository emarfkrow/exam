...
$(function() {
    Tb3RirekiGridColumns = [
        Column.comma('RIREKI_MOTO_ID', Messages['Tb3RirekiGrid.rirekiMotoId'], 80, 'primaryKey numbering', null),
        Column.comma('RIREKI_BN', Messages['Tb3RirekiGrid.rirekiBn'], 80, 'primaryKey numbering', null),
