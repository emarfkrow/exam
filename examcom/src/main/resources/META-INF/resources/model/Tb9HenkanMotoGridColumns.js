...
$(function() {
    Tb9HenkanMotoGridColumns = [
        Column.text('HENKAN_MOTO_ID', Messages['Tb9HenkanMotoGrid.henkanMotoId'], 90, 'primaryKey numbering', null),
        ...
        Column.cell('UPDATE_TS', Messages['Tb9HenkanMotoGrid.updateTs'], 207, 'metaInfo', Slick.Formatters.Extends.Timestamp),
    ];
});
