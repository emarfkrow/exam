...
$(function() {
    Tb3RirekiSakiGridColumns = [
        Column.comma('RIREKI_MOTO_ID', Messages['Tb3RirekiSakiGrid.rirekiMotoId'], 80, 'primaryKey numbering', null),
        Column.comma('RIREKI_BN', Messages['Tb3RirekiSakiGrid.rirekiBn'], 80, 'primaryKey numbering', null),
