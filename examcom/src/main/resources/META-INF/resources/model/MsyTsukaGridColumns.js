...
$(function() {
    MsyTsukaGridColumns = [
        ...
        Column.check('DELETE_F', Messages['MsyTsukaGrid.deleteF'], 30, ''),
        Column.select('STATUS_KB', Messages['MsyTsukaGrid.statusKb'], 30, '', { json: 'MsyKbnValSearch.json', paramkey: 'KBN_NM', value: 'KBN_VAL', label: 'KBN_VAL_MEI' }),
    ];
});
