...
$(function() {
    Tb6HaseiSaki2DetGridColumns = [
        Column.text('HASEI_SAKI2_ID', Messages['Tb6HaseiSaki2DetGrid.haseiSaki2Id'], 90, 'primaryKey numbering', null),
        Column.text('HASEI_SAKI2_BN', Messages['Tb6HaseiSaki2DetGrid.haseiSaki2Bn'], 90, 'primaryKey numbering', null),
