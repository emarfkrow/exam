...
$(function() {
    Tb6ShuyakuYokushiMoto1GridColumns = [
        Column.comma('SHUYAKU_YOKUSHI_MOTO1_ID', Messages['Tb6ShuyakuYokushiMoto1Grid.shuyakuYokushiMoto1Id'], 80, 'primaryKey numbering', null),
        Column.comma('SHUYAKU_YOKUSHI_ID', Messages['Tb6ShuyakuYokushiMoto1Grid.shuyakuYokushiId'], 80, '', null),
