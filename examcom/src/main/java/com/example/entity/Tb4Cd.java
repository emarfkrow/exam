 ...
 * @author emarfkrow
 */
public class Tb4Cd implements IEntity {
     ...
     * @return CDマスタ
     */
    public static Tb4Cd get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb4Cd.class);
    }
    ...
    public int delete() {
        ...
        // CDマスタの削除
        String sql = "DELETE FROM TB4_CD WHERE " + getWhere();
