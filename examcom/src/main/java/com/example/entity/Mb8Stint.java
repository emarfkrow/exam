 ...
 * @author emarfkrow
 */
public class Mb8Stint implements IEntity {
     ...
     * @return 制約マスタ
     */
    public static Mb8Stint get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb8Stint.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 制約マスタの登録
        String sql = "INSERT INTO MB8_STINT(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`STINT_ID`) IS NULL THEN 0 ELSE MAX(e.`STINT_ID`) * 1 END + 1 AS `STINT_ID` FROM MB8_STINT e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 制約マスタの削除
        String sql = "DELETE FROM MB8_STINT WHERE " + getWhere();
