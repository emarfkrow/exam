...
public class Tb2Entity implements IEntity {
    ...
    public static Tb2Entity get(final Object param1) {
        ...
        sql += "    , RTRIM (RTRIM (a.\"NULL_CHECK_F\"), '　') AS NULL_CHECK_F \n";
        sql += "    , a.\"NULL_RADIO_KB\" \n";
        sql += "    , a.\"NULL_PULLDOWN_KB\" \n";
        sql += "    , a.\"NULL_MEMO_TX\" \n";
        sql += "    , RTRIM (RTRIM (a.\"NULL_NEN_Y\"), '　') AS NULL_NEN_Y \n";
        sql += "    , RTRIM (RTRIM (a.\"NULL_TSUKI_M\"), '　') AS NULL_TSUKI_M \n";
        sql += "    , RTRIM (RTRIM (a.\"NULL_HI_D\"), '　') AS NULL_HI_D \n";
        sql += "    , RTRIM (RTRIM (a.\"NULL_NENGETSU_YM\"), '　') AS NULL_NENGETSU_YM \n";
        sql += "    , RTRIM (RTRIM (a.\"NULL_NENGAPPI_YMD\"), '　') AS NULL_NENGAPPI_YMD \n";
        sql += "    , TO_CHAR (a.\"NULL_TIMESTAMP_TS\", 'YYYY-MM-DD HH24:MI:SS.FF3') AS NULL_TIMESTAMP_TS \n";
        sql += "    , TO_CHAR (a.\"NULL_NICHIJI_DT\", 'YYYY-MM-DD HH24:MI:SS') AS NULL_NICHIJI_DT \n";
        sql += "    , TO_CHAR (a.\"NULL_HIDUKE_BI\", 'YYYY-MM-DD') AS NULL_HIDUKE_BI \n";
    ...
    private String values() {
        ...
        valueList.add("TO_TIMESTAMP (REPLACE (SUBSTR (:null_timestamp_ts, 0, 23), 'T', ' '), 'YYYY-MM-DD HH24:MI:SS.FF3')");
        valueList.add("TO_TIMESTAMP (REPLACE (SUBSTR (:null_nichiji_dt, 0, 23), 'T', ' '), 'YYYY-MM-DD HH24:MI:SS.FF3')");
        valueList.add("TO_DATE (SUBSTR (:null_hiduke_bi, 0, 10), 'YYYY-MM-DD')");
    ...
    private String getSet() {
        ...
        setList.add("\"NULL_TIMESTAMP_TS\" = TO_TIMESTAMP (REPLACE (SUBSTR (:null_timestamp_ts, 0, 23), 'T', ' '), 'YYYY-MM-DD HH24:MI:SS.FF3')");
        setList.add("\"NULL_NICHIJI_DT\" = TO_TIMESTAMP (REPLACE (SUBSTR (:null_nichiji_dt, 0, 23), 'T', ' '), 'YYYY-MM-DD HH24:MI:SS.FF3')");
        setList.add("\"NULL_HIDUKE_BI\" = TO_DATE (SUBSTR (:null_hiduke_bi, 0, 10), 'YYYY-MM-DD')");
