 ...
 * @author emarfkrow
 */
public class Tb3Temp implements IEntity {
    ...
    /** @return 当初情報 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "TEMP_INFO", index = 3)
     ...
     * @return 当初
     */
    public static Tb3Temp get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb3Temp.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 履歴の登録
        Tb3TempHis tb3TempHis = new Tb3TempHis();
        tb3TempHis.setTempId(this.tempId);
        tb3TempHis.setTempInfo(this.tempInfo);
        tb3TempHis.setInsertTs(this.insertTs);
        tb3TempHis.setInsertUserId(this.insertUserId);
        tb3TempHis.setUpdateTs(this.updateTs);
        tb3TempHis.setUpdateUserId(this.updateUserId);
        tb3TempHis.setReason(this.reason);
        tb3TempHis.insert(now, execId);

        // 当初の登録
        String sql = "INSERT INTO TB3_TEMP(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`TEMP_ID`) IS NULL THEN 0 ELSE MAX(e.`TEMP_ID`) * 1 END + 1 AS `TEMP_ID` FROM TB3_TEMP e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("TEMP_ID");
        this.setTempId(o);
    }
    ...
    public int delete() {
        ...
        // 当初の削除
        String sql = "DELETE FROM TB3_TEMP WHERE " + getWhere();
