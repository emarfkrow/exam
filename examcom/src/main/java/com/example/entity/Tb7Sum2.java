 ...
 * @author emarfkrow
 */
public class Tb7Sum2 implements IEntity {
     ...
     * @return 集約抑止
     */
    public static Tb7Sum2 get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb7Sum2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 集約抑止の登録
        String sql = "INSERT INTO TB7_SUM2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SUM2_ID`) IS NULL THEN 0 ELSE MAX(e.`SUM2_ID`) * 1 END + 1 AS `SUM2_ID` FROM TB7_SUM2 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 集約抑止の削除
        String sql = "DELETE FROM TB7_SUM2 WHERE " + getWhere();
