 ...
 * @author emarfkrow
 */
public class Mb8Refer implements IEntity {
     ...
     * @return 参照マスタ
     */
    public static Mb8Refer get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb8Refer.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照マスタの登録
        String sql = "INSERT INTO MB8_REFER(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REFER_ID`) IS NULL THEN 0 ELSE MAX(e.`REFER_ID`) * 1 END + 1 AS `REFER_ID` FROM MB8_REFER e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 参照マスタの削除
        String sql = "DELETE FROM MB8_REFER WHERE " + getWhere();
