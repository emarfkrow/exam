 ...
 * @author emarfkrow
 */
public class Tb8Refer implements IEntity {
     ...
     * @return 参照マスタ
     */
    public static Tb8Refer get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb8Refer.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照マスタの登録
        String sql = "INSERT INTO TB8_REFER(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`REFER_MEI` -- :refer_mei");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`REFER_ID`) IS NULL THEN 0 ELSE MAX(e.`REFER_ID`) * 1 END + 1 AS `REFER_ID` FROM TB8_REFER e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("REFER_ID");
        this.setReferId(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`REFER_MEI` = :refer_mei");
    ...
    public int delete() {
        ...
        // 参照マスタの削除
        String sql = "DELETE FROM TB8_REFER WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("refer_mei", this.referMei);
