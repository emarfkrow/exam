 ...
 * @author emarfkrow
 */
public class Tb9HenkanSaki implements IEntity {
     ...
     * @return 変換先
     */
    public static Tb9HenkanSaki get(final Object param1) {
        ...
        sql += "FROM \n";
        sql += "    TB9_HENKAN_SAKI a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("henkan_saki_id", param1);
        return Queries.get(sql, map, Tb9HenkanSaki.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 変換先の登録
        String sql = "INSERT INTO TB9_HENKAN_SAKI(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`HENKAN_SAKI_ID`) IS NULL THEN 0 ELSE MAX(e.`HENKAN_SAKI_ID`) * 1 END + 1 AS `HENKAN_SAKI_ID` FROM TB9_HENKAN_SAKI e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 変換先の登録
        String sql = "UPDATE TB9_HENKAN_SAKI\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 変換先の削除
        String sql = "DELETE FROM TB9_HENKAN_SAKI WHERE " + getWhere();
