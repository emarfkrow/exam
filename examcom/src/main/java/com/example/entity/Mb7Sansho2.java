 ...
 * @author emarfkrow
 */
public class Mb7Sansho2 implements IEntity {
     ...
     * @return 参照２マスタ
     */
    public static Mb7Sansho2 get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb7Sansho2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照２マスタの登録
        String sql = "INSERT INTO MB7_SANSHO2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SANSHO2_ID`) IS NULL THEN 0 ELSE MAX(e.`SANSHO2_ID`) * 1 END + 1 AS `SANSHO2_ID` FROM MB7_SANSHO2 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 参照２マスタの削除
        String sql = "DELETE FROM MB7_SANSHO2 WHERE " + getWhere();
