 ...
 * @author emarfkrow
 */
public class NewEntity1 implements IEntity {
    ...
    public static NewEntity1 get() {
        ...
        return Queries.get(sql, map, NewEntity1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // VIEWの登録
        String sql = "INSERT INTO NEW_ENTITY1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // VIEWの削除
        String sql = "DELETE FROM NEW_ENTITY1 WHERE " + getWhere();
