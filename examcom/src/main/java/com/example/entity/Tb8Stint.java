 ...
 * @author emarfkrow
 */
public class Tb8Stint implements IEntity {
    ...
    /** @return 制約ID */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "STINT_ID", index = 2)
    ...
    /** @return 制約名 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "STINT_MEI", index = 3)
     ...
     * @return 制約マスタ
     */
    public static Tb8Stint get(final Object param1) {
        ...
        map.put("stint_id", param1);
        return Queries.get(sql, map, Tb8Stint.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 制約マスタの登録
        String sql = "INSERT INTO TB8_STINT(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`STINT_MEI` -- :stint_mei");
    ...
    private void numbering() {
        if (this.stintId != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`STINT_ID`) IS NULL THEN 0 ELSE MAX(e.`STINT_ID`) * 1 END + 1 AS `STINT_ID` FROM TB8_STINT e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("STINT_ID");
        this.setStintId(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`STINT_MEI` = :stint_mei");
    ...
    public int delete() {
        ...
        // 制約マスタの削除
        String sql = "DELETE FROM TB8_STINT WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("stint_mei", this.stintMei);
