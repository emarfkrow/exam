 ...
 * @author emarfkrow
 */
public class Tb4No implements IEntity {
     ...
     * @return NOマスタ
     */
    public static Tb4No get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb4No.class);
    }
    ...
    public int delete() {
        ...
        // NOマスタの削除
        String sql = "DELETE FROM TB4_NO WHERE " + getWhere();
