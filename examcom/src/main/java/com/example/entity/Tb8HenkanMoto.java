 ...
 * @author emarfkrow
 */
public class Tb8HenkanMoto implements IEntity {
     ...
     * @return 変換元
     */
    public static Tb8HenkanMoto get(final Object param1) {
        ...
        sql += "FROM \n";
        sql += "    TB8_HENKAN_MOTO a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("henkan_moto_id", param1);
        return Queries.get(sql, map, Tb8HenkanMoto.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 変換元の登録
        String sql = "INSERT INTO TB8_HENKAN_MOTO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`HENKAN_MOTO_ID`) IS NULL THEN 0 ELSE MAX(e.`HENKAN_MOTO_ID`) * 1 END + 1 AS `HENKAN_MOTO_ID` FROM TB8_HENKAN_MOTO e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 変換元の登録
        String sql = "UPDATE TB8_HENKAN_MOTO\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 変換元の削除
        String sql = "DELETE FROM TB8_HENKAN_MOTO WHERE " + getWhere();
