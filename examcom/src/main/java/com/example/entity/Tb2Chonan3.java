 ...
 * @author emarfkrow
 */
public class Tb2Chonan3 implements IEntity {
    ...
    /** @return 長男３情報 */
    @com.fasterxml.jackson.annotation.JsonProperty("CHONAN3_INFO")
    public String getChonan3Info() {
        return this.chonan3Info;
    }

    /** @param o 長男３情報 */
    public void setChonan3Info(final Object o) {
        if (o != null) {
            this.chonan3Info = o.toString();
        } else {
            this.chonan3Info = null;
        }
    }
    ...
    public static Tb2Chonan3 get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb2Chonan3.class);
    }
    ...
    private String names() {
        ...
        nameList.add("`CHONAN3_INFO` -- :chonan_3_info");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`CHONAN_ID`) IS NULL THEN 0 ELSE MAX(e.`CHONAN_ID`) * 1 END + 1 AS `CHONAN_ID` FROM TB2_CHONAN3 e";
        Map<String, Object> map = new HashMap<String, Object>();
