 ...
 * @author emarfkrow
 */
public class Tb3Kyodai3 implements IEntity {
     ...
     * @return 兄弟３
     */
    public static Tb3Kyodai3 get(final Object param1, final Object param2) {
        ...
        return Queries.get(sql, map, Tb3Kyodai3.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 兄弟３の登録
        String sql = "INSERT INTO TB3_KYODAI3(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KO_BN`) IS NULL THEN 0 ELSE MAX(e.`KO_BN`) * 1 END + 1 AS `KO_BN` FROM TB3_KYODAI3 e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int delete() {
        ...
        // 兄弟３の削除
        String sql = "DELETE FROM TB3_KYODAI3 WHERE " + getWhere();
    ...
    public List<Tb1Mago> referTb1Magos() {
        this.tb1Magos = Tb3Kyodai3.referTb1Magos(this.oyaId, this.koBn);
        return this.tb1Magos;
    }
