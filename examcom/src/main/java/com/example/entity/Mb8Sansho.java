 ...
 * @author emarfkrow
 */
public class Mb8Sansho implements IEntity {
     ...
     * @return 参照マスタ
     */
    public static Mb8Sansho get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb8Sansho.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照マスタの登録
        String sql = "INSERT INTO MB8_SANSHO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`SANSHO_MEI` -- :sansho_mei");
    ...
    private void numbering() {
        if (this.sanshoId != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`SANSHO_ID`) IS NULL THEN 0 ELSE MAX(e.`SANSHO_ID`) * 1 END + 1 AS `SANSHO_ID` FROM MB8_SANSHO e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("SANSHO_ID");
        this.setSanshoId(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`SANSHO_MEI` = :sansho_mei");
    ...
    public int delete() {
        ...
        // 参照マスタの削除
        String sql = "DELETE FROM MB8_SANSHO WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("sansho_mei", this.sanshoMei);
