 ...
 * @author emarfkrow
 */
public class Mb4Nosansho implements IEntity {
    ...
    public static Mb4Nosansho get(final Object param1) {
        ...
        map.put("nosansho_no", param1);
        return Queries.get(sql, map, Mb4Nosansho.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // NO参照マスタの登録
        String sql = "INSERT INTO MB4_NOSANSHO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // NO参照マスタの登録
        String sql = "UPDATE MB4_NOSANSHO\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // NO参照マスタの削除
        String sql = "DELETE FROM MB4_NOSANSHO WHERE " + getWhere();
