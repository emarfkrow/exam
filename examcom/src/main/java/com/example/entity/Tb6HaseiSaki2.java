 ...
 * @author emarfkrow
 */
public class Tb6HaseiSaki2 implements IEntity {
     ...
     * @return 派生先２
     */
    public static Tb6HaseiSaki2 get(final Object param1) {
        ...
        sql += "FROM \n";
        sql += "    TB6_HASEI_SAKI2 a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("hasei_saki_2_id", param1);
        return Queries.get(sql, map, Tb6HaseiSaki2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        if (this.tb6HaseiSaki2Dets != null) {
            for (Tb6HaseiSaki2Det tb6HaseiSaki2Det : this.tb6HaseiSaki2Dets) {
                if (tb6HaseiSaki2Det != null) {
                    tb6HaseiSaki2Det.setHaseiSaki2Id(this.getHaseiSaki2Id());
                }
        ...
        // 派生先２の登録
        String sql = "INSERT INTO TB6_HASEI_SAKI2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        if (this.haseiSaki2Id != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`HASEI_SAKI2_ID`) IS NULL THEN 0 ELSE MAX(e.`HASEI_SAKI2_ID`) * 1 END + 1 AS `HASEI_SAKI2_ID` FROM TB6_HASEI_SAKI2 e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("HASEI_SAKI2_ID");
        this.setHaseiSaki2Id(o);
    }
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        if (this.tb6HaseiSaki2Dets != null) {
            for (Tb6HaseiSaki2Det tb6HaseiSaki2Det : this.tb6HaseiSaki2Dets) {
                ...
                tb6HaseiSaki2Det.setHaseiSaki2Id(this.haseiSaki2Id);
                try {
                    tb6HaseiSaki2Det.insert(now, execId);
                } catch (Exception e) {
        ...
        // 派生先２の登録
        String sql = "UPDATE TB6_HASEI_SAKI2\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 派生先２の削除
        String sql = "DELETE FROM TB6_HASEI_SAKI2 WHERE " + getWhere();
    ...
    public List<Tb6HaseiSaki2Det> referTb6HaseiSaki2Dets() {
        this.tb6HaseiSaki2Dets = Tb6HaseiSaki2.referTb6HaseiSaki2Dets(this.haseiSaki2Id);
        return this.tb6HaseiSaki2Dets;
    }

    /**
     * @param param1 haseiSaki2Id
    ...
    public static List<Tb6HaseiSaki2Det> referTb6HaseiSaki2Dets(final Integer param1) {
        ...
        sql += " ORDER BY ";
        sql += "HASEI_SAKI2_ID, HASEI_SAKI2_BN";
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("hasei_saki_2_id", param1);
