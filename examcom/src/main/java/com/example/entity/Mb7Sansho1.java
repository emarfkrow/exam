 ...
 * @author emarfkrow
 */
public class Mb7Sansho1 implements IEntity {
     ...
     * @return 参照１マスタ
     */
    public static Mb7Sansho1 get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb7Sansho1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照１マスタの登録
        String sql = "INSERT INTO MB7_SANSHO1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SANSHO1_ID`) IS NULL THEN 0 ELSE MAX(e.`SANSHO1_ID`) * 1 END + 1 AS `SANSHO1_ID` FROM MB7_SANSHO1 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 参照１マスタの削除
        String sql = "DELETE FROM MB7_SANSHO1 WHERE " + getWhere();
