 ...
 * @author emarfkrow
 */
public class Tb2Koji2 implements IEntity {
    ...
    /** @return 孤児２情報 */
    @com.fasterxml.jackson.annotation.JsonProperty("KOJI2_INFO")
    public String getKoji2Info() {
        return this.koji2Info;
    }

    /** @param o 孤児２情報 */
    public void setKoji2Info(final Object o) {
        if (o != null) {
            this.koji2Info = o.toString();
        } else {
            this.koji2Info = null;
        }
    }
     ...
     * @return 孤児２
     */
    public static Tb2Koji2 get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb2Koji2.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 孤児２の登録
        String sql = "INSERT INTO TB2_KOJI2(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`KOJI2_INFO` -- :koji_2_info");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KOJI_ID`) IS NULL THEN 0 ELSE MAX(e.`KOJI_ID`) * 1 END + 1 AS `KOJI_ID` FROM TB2_KOJI2 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private String getSet() {
        ...
        setList.add("`KOJI2_INFO` = :koji_2_info");
    ...
    public int delete() {
        ...
        // 孤児２の削除
        String sql = "DELETE FROM TB2_KOJI2 WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("koji_2_info", this.koji2Info);
