 ...
 * @author emarfkrow
 */
public class Tb1KoOrphans implements IEntity {
    ...
    /** @return 子３情報 */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "KO3_INFO", index = 4)
    public String getKo3Info() {
        return this.ko3Info;
    }

    /** @param o 子３情報 */
    public void setKo3Info(final Object o) {
        if (o != null) {
            this.ko3Info = o.toString();
        } else {
            this.ko3Info = null;
        }
    }
     ...
     * @return 孤児
     */
    public static Tb1KoOrphans get(final Object param1, final Object param2) {
        ...
        sql += "FROM \n";
        sql += "    TB1_KO_ORPHANS a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("oya_id", param1);
        map.put("ko_bn", param2);
        return Queries.get(sql, map, Tb1KoOrphans.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 孤児の登録
        String sql = "INSERT INTO TB1_KO_ORPHANS(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`KO3_INFO` -- :ko_3_info");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`KO_BN`) IS NULL THEN 0 ELSE MAX(e.`KO_BN`) * 1 END + 1 AS `KO_BN` FROM TB1_KO_ORPHANS e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 孤児の登録
        String sql = "UPDATE TB1_KO_ORPHANS\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 子なしの削除
        if (this.tb1KoDinks != null) {
            if (this.tb1KoDinks.delete() != 1) {
                throw new jp.co.golorp.emarf.exception.OptLockError("error.cant.delete", "子なし");
            }
        }

        // 孤児の削除
        String sql = "DELETE FROM TB1_KO_ORPHANS WHERE " + getWhere();
    ...
    /** @return 子なし */
    @com.fasterxml.jackson.annotation.JsonProperty(value = "Tb1KoDinks", index = 12)
    ...
    public List<Tb1Mago> referTb1Magos() {
        this.tb1Magos = Tb1KoOrphans.referTb1Magos(this.oyaId, this.koBn);
        return this.tb1Magos;
    }
