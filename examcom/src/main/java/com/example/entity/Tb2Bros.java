 ...
 * @author emarfkrow
 */
public class Tb2Bros implements IEntity {
    ...
    /** @return 兄弟情報 */
    @com.fasterxml.jackson.annotation.JsonProperty("BROS_INFO")
    public String getBrosInfo() {
        return this.brosInfo;
    }

    /** @param o 兄弟情報 */
    public void setBrosInfo(final Object o) {
        if (o != null) {
            this.brosInfo = o.toString();
        } else {
            this.brosInfo = null;
        }
    }
    ...
    public static Tb2Bros get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb2Bros.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 兄弟の登録
        String sql = "INSERT INTO TB2_BROS(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`BROS_INFO` -- :bros_info");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`BROS_ID`) IS NULL THEN 0 ELSE MAX(e.`BROS_ID`) * 1 END + 1 AS `BROS_ID` FROM TB2_BROS e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 兄弟の削除
        String sql = "DELETE FROM TB2_BROS WHERE " + getWhere();
