 ...
 * @author emarfkrow
 */
public class Tb1KoRireki implements IEntity {
     ...
     * @return 履歴
     */
    public static Tb1KoRireki get(final Object param1, final Object param2, final Object param3) {
        ...
        map.put("rireki_bn", param3);
        return Queries.get(sql, map, Tb1KoRireki.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 履歴の登録
        String sql = "INSERT INTO TB1_KO_RIREKI(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`RIREKI_BN`) IS NULL THEN 0 ELSE MAX(e.`RIREKI_BN`) * 1 END + 1 AS `RIREKI_BN` FROM TB1_KO_RIREKI e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 履歴の登録
        String sql = "UPDATE TB1_KO_RIREKI\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 履歴の削除
        String sql = "DELETE FROM TB1_KO_RIREKI WHERE " + getWhere();
