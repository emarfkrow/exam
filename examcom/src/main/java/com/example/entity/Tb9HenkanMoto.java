 ...
 * @author emarfkrow
 */
public class Tb9HenkanMoto implements IEntity {
    ...
    /** @return 引継ぐ情報 */
    @com.fasterxml.jackson.annotation.JsonProperty("HIKITSUGU_INFO")
    public String getHikitsuguInfo() {
        return this.hikitsuguInfo;
    }

    /** @param o 引継ぐ情報 */
    public void setHikitsuguInfo(final Object o) {
        if (o != null) {
            this.hikitsuguInfo = o.toString();
        } else {
            this.hikitsuguInfo = null;
        }
    }
     ...
     * @return 変換元
     */
    public static Tb9HenkanMoto get(final Object param1) {
        ...
        sql += "    , a.`HIKITSUGU_INFO` \n";
        sql += "    , a.`INSERT_TS` AS INSERT_TS \n";
        sql += "    , a.`INSERT_USER_ID` \n";
        sql += "    , a.`UPDATE_TS` AS UPDATE_TS \n";
        sql += "    , a.`UPDATE_USER_ID` \n";
        sql += "FROM \n";
        sql += "    TB9_HENKAN_MOTO a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("henkan_moto_id", param1);
        return Queries.get(sql, map, Tb9HenkanMoto.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 変換元の登録
        String sql = "INSERT INTO TB9_HENKAN_MOTO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`HIKITSUGU_INFO` -- :hikitsugu_info");
    ...
    private void numbering() {
        if (this.henkanMotoId != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`HENKAN_MOTO_ID`) IS NULL THEN 0 ELSE MAX(e.`HENKAN_MOTO_ID`) * 1 END + 1 AS `HENKAN_MOTO_ID` FROM TB9_HENKAN_MOTO e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("HENKAN_MOTO_ID");
        this.setHenkanMotoId(o);
    }
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 変換元の登録
        String sql = "UPDATE TB9_HENKAN_MOTO\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    private String getSet() {
        ...
        setList.add("`HIKITSUGU_INFO` = :hikitsugu_info");
    ...
    public int delete() {
        ...
        // 変換元の削除
        String sql = "DELETE FROM TB9_HENKAN_MOTO WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("hikitsugu_info", this.hikitsuguInfo);
