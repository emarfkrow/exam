 ...
 * @author emarfkrow
 */
public class Tb2Daihyo implements IEntity {
    ...
    /** @return 代表情報 */
    @com.fasterxml.jackson.annotation.JsonProperty("DAIHYO_INFO")
    public String getDaihyoInfo() {
        return this.daihyoInfo;
    }

    /** @param o 代表情報 */
    public void setDaihyoInfo(final Object o) {
        if (o != null) {
            this.daihyoInfo = o.toString();
        } else {
            this.daihyoInfo = null;
        }
    }
    ...
    public static Tb2Daihyo get(final Object param1) {
        ...
        return Queries.get(sql, map, Tb2Daihyo.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 代表の登録
        String sql = "INSERT INTO TB2_DAIHYO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`DAIHYO_INFO` -- :daihyo_info");
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`DAIHYO_ID`) IS NULL THEN 0 ELSE MAX(e.`DAIHYO_ID`) * 1 END + 1 AS `DAIHYO_ID` FROM TB2_DAIHYO e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    private String getSet() {
        ...
        setList.add("`DAIHYO_INFO` = :daihyo_info");
    ...
    public int delete() {
        ...
        // 代表の削除
        String sql = "DELETE FROM TB2_DAIHYO WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("daihyo_info", this.daihyoInfo);
