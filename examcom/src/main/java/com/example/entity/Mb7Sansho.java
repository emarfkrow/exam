 ...
 * @author emarfkrow
 */
public class Mb7Sansho implements IEntity {
     ...
     * @return 参照マスタ
     */
    public static Mb7Sansho get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb7Sansho.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 参照マスタの登録
        String sql = "INSERT INTO MB7_SANSHO(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SANSHO_ID`) IS NULL THEN 0 ELSE MAX(e.`SANSHO_ID`) * 1 END + 1 AS `SANSHO_ID` FROM MB7_SANSHO e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 参照マスタの削除
        String sql = "DELETE FROM MB7_SANSHO WHERE " + getWhere();
