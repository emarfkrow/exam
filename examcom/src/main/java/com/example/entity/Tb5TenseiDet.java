 ...
 * @author emarfkrow
 */
public class Tb5TenseiDet implements IEntity {
     ...
     * @return 転生明細
     */
    public static Tb5TenseiDet get(final Object param1, final Object param2) {
        ...
        sql += "FROM \n";
        sql += "    TB5_TENSEI_DET a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("tensei_id", param1);
        map.put("tensei_bn", param2);
        return Queries.get(sql, map, Tb5TenseiDet.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 転生明細の登録
        String sql = "INSERT INTO TB5_TENSEI_DET(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`TENSEI_BN`) IS NULL THEN 0 ELSE MAX(e.`TENSEI_BN`) * 1 END + 1 AS `TENSEI_BN` FROM TB5_TENSEI_DET e";
        Map<String, Object> map = new HashMap<String, Object>();
        List<String> whereList = new ArrayList<String>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 転生明細の登録
        String sql = "UPDATE TB5_TENSEI_DET\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 転生明細の削除
        String sql = "DELETE FROM TB5_TENSEI_DET WHERE " + getWhere();
