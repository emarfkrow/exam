 ...
 * @author emarfkrow
 */
public class Tb6ShuyakuYokushiMoto1 implements IEntity {
     ...
     * @return 集約抑止元１
     */
    public static Tb6ShuyakuYokushiMoto1 get(final Object param1) {
        ...
        sql += "    , a.`STATUS_KB` \n";
        sql += "FROM \n";
        sql += "    TB6_SHUYAKU_YOKUSHI_MOTO1 a \n";
        sql += "WHERE \n";
        sql += String.join(" AND \n", whereList);
        Map<String, Object> map = new HashMap<String, Object>();
        map.put("shuyaku_yokushi_moto_1_id", param1);
        return Queries.get(sql, map, Tb6ShuyakuYokushiMoto1.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 集約抑止元１の登録
        String sql = "INSERT INTO TB6_SHUYAKU_YOKUSHI_MOTO1(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SHUYAKU_YOKUSHI_MOTO1_ID`) IS NULL THEN 0 ELSE MAX(e.`SHUYAKU_YOKUSHI_MOTO1_ID`) * 1 END + 1 AS `SHUYAKU_YOKUSHI_MOTO1_ID` FROM TB6_SHUYAKU_YOKUSHI_MOTO1 e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 集約抑止元１の登録
        String sql = "UPDATE TB6_SHUYAKU_YOKUSHI_MOTO1\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 集約抑止元１の削除
        String sql = "DELETE FROM TB6_SHUYAKU_YOKUSHI_MOTO1 WHERE " + getWhere();
