 ...
 * @author emarfkrow
 */
public class Mb8Seiyaku implements IEntity {
     ...
     * @return 制約マスタ
     */
    public static Mb8Seiyaku get(final Object param1) {
        ...
        return Queries.get(sql, map, Mb8Seiyaku.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 制約マスタの登録
        String sql = "INSERT INTO MB8_SEIYAKU(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private void numbering() {
        ...
        String sql = "SELECT CASE WHEN MAX(e.`SEIYAKU_ID`) IS NULL THEN 0 ELSE MAX(e.`SEIYAKU_ID`) * 1 END + 1 AS `SEIYAKU_ID` FROM MB8_SEIYAKU e";
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    public int delete() {
        ...
        // 制約マスタの削除
        String sql = "DELETE FROM MB8_SEIYAKU WHERE " + getWhere();
