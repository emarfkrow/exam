 ...
 * @author emarfkrow
 */
public class Vb8Etsuran implements IEntity {
    ...
    public static Vb8Etsuran get() {
        ...
        return Queries.get(sql, map, Vb8Etsuran.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // VIEWの登録
        String sql = "INSERT INTO VB8_ETSURAN(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int delete() {
        ...
        // VIEWの削除
        String sql = "DELETE FROM VB8_ETSURAN WHERE " + getWhere();
