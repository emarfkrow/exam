 ...
 * @author emarfkrow
 */
public class Tb6HaseiSaki2Det implements IEntity {
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 派生先２明細の登録
        String sql = "INSERT INTO TB6_HASEI_SAKI2_DET(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    public int update(final LocalDateTime now, final String execId) {
        ...
        // 派生先２明細の登録
        String sql = "UPDATE TB6_HASEI_SAKI2_DET\r\nSET\r\n      " + getSet() + "\r\nWHERE\r\n    " + getWhere();
        return Queries.regist(sql, toMap(now, execId));
    }
    ...
    public int delete() {
        ...
        // 派生先２明細の削除
        String sql = "DELETE FROM TB6_HASEI_SAKI2_DET WHERE " + getWhere();
