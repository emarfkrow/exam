 ...
 * @author emarfkrow
 */
public class Mb7Seiyaku implements IEntity {
     ...
     * @return 制約マスタ
     */
    public static Mb7Seiyaku get(final Object param1) {
        ...
        map.put("seiyaku_id", param1);
        return Queries.get(sql, map, Mb7Seiyaku.class);
    }
    ...
    public int insert(final LocalDateTime now, final String execId) {
        ...
        // 制約マスタの登録
        String sql = "INSERT INTO MB7_SEIYAKU(\r\n      " + names() + "\r\n) VALUES (\r\n      " + values() + "\r\n)";
    ...
    private String names() {
        ...
        nameList.add("`SEIYAKU_MEI` -- :seiyaku_mei");
    ...
    private void numbering() {
        if (this.seiyakuId != null) {
            return;
        }
        String sql = "SELECT CASE WHEN MAX(e.`SEIYAKU_ID`) IS NULL THEN 0 ELSE MAX(e.`SEIYAKU_ID`) * 1 END + 1 AS `SEIYAKU_ID` FROM MB7_SEIYAKU e";
        Map<String, Object> map = new HashMap<String, Object>();
        jp.co.golorp.emarf.util.MapList mapList = Queries.select(sql, map, null, null);
        Object o = mapList.get(0).get("SEIYAKU_ID");
        this.setSeiyakuId(o);
    }
    ...
    private String getSet() {
        ...
        setList.add("`SEIYAKU_MEI` = :seiyaku_mei");
    ...
    public int delete() {
        ...
        // 制約マスタの削除
        String sql = "DELETE FROM MB7_SEIYAKU WHERE " + getWhere();
    ...
    private Map<String, Object> toMap(final LocalDateTime now, final String execId) {
        ...
        map.put("seiyaku_mei", this.seiyakuMei);
