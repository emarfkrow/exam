...
public class Tb5RebornSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("Tb5RebornGrid");
        for (Map<String, Object> gridRow : gridData) {
            ...
            // 主キーが不足していたらエラー
            if (jp.co.golorp.emarf.lang.StringUtil.isNullOrBlank(gridRow.get("REBORN_ID"))) {
                throw new OptLockError("error.cant.delete");
            }

            Tb5Reborn e = FormValidator.toBean(Tb5Reborn.class.getName(), gridRow);
