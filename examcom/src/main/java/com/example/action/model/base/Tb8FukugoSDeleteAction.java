 ...
 * @author emarfkrow
 */
public class Tb8FukugoSDeleteAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        List<Map<String, Object>> gridData = (List<Map<String, Object>>) postJson.get("Tb8FukugoGrid");
        for (Map<String, Object> gridRow : gridData) {
            ...
            Tb8Fukugo e = FormValidator.toBean(Tb8Fukugo.class.getName(), gridRow);
            if (e.delete() != 1) {
                throw new OptLockError("error.cant.delete");
            }
            ++count;
