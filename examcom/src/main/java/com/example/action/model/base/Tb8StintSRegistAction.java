 ...
 * @author emarfkrow
 */
public class Tb8StintSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb8StintGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                if (isNew) {
                    ...
                    if (e.insert(now, execId) != 1) {
                        throw new OptLockError("error.cant.insert", "制約マスタ");
                    }
                    ++count;
                    ...
                    if (e.update(now, execId) != 1) {
                        throw new OptLockError("error.cant.update", "制約マスタ");
                    }
                    ++count;
                }
            }
