...
public class Tb4IdbnSRegistAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> form) {
        ...
        List<Map<String, Object>> data = (List<Map<String, Object>>) form.get("Tb4IdbnGrid");
        if (data != null) {
            for (Map<String, Object> row : data) {
                ...
                Tb4Idbn e = FormValidator.toBean(Tb4Idbn.class.getName(), row);
                ...
                if (isNew) {
                    ...
                    if (e.insert(now, execId) != 1) {
                        throw new OptLockError("error.cant.insert", "ID-BNマスタ");
                    }
                    ++count;
                    ...
                    if (e.update(now, execId) != 1) {
                        throw new OptLockError("error.cant.update", "ID-BNマスタ");
                    }
                    ++count;
                }
            }
