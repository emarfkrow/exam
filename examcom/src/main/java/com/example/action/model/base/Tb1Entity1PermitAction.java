 ...
 * @author emarfkrow
 */
public class Tb1Entity1PermitAction extends BaseAction {
    ...
    public Map<String, Object> running(final LocalDateTime now, final String execId, final Map<String, Object> postJson) {
        ...
        Tb1Entity1 e = FormValidator.toBean(Tb1Entity1.class.getName(), postJson);

        // child:Tb1Ko, parents:5

        // child:Tb1TenpuFile, parents:5

        Tb1Entity1 f = Tb1Entity1.get(e.getSosenId(), e.getOyaBn(), e.getEntityBn());
        f.setStatusKb(1);
