...
DROP TABLE tb2_koji CASCADE;
DROP TABLE tb2_koji2 CASCADE;
DROP TABLE tb2_koji3 CASCADE;
DROP TABLE tb2_kyodai CASCADE;
DROP TABLE tb2_kyodai2 CASCADE;
DROP TABLE tb2_kyodai3 CASCADE;
DROP TABLE tb2_mattei CASCADE;
DROP TABLE tb2_mattei2 CASCADE;
DROP TABLE tb2_mattei3 CASCADE;
DROP TABLE tb3_rireki CASCADE;
DROP TABLE tb3_rireki_moto CASCADE;
